 ...
 * </pre>
 */
public class CBinaryHttpResponseHandler extends AsyncHttpResponseHandler {
     ...
     */
    public CBinaryHttpResponseHandler() {
        // Set up a handler to post events back to the correct thread if possible
        if(Looper.myLooper() != null) {
            handler = new Handler(){
                @Override
                public void handleMessage(Message msg){
                    CBinaryHttpResponseHandler.this.handleMessage(msg);
                }
            };
        }
    }
